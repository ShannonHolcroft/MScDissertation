...
row.names(mat4.2A2_mva) = mat4.2A_mva_wide$Outcome
...
row.names(mat4.2A2_qft) = mat4.2A_qft_wide$Outcome
...
mat4.2A2_fa = as.matrix(cbind(unlist(mat4.2A_fa_wide[, 2]), unlist(mat4.2A_fa_wide[, 3]), unlist(mat4.2A_fa_wide[, 4])), nrow = nrow(mat4.2A_fa_wide), ncol = 3)
