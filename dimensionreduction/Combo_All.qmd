...
hcdata4.2_qft = dendro_data_k(res4.2.hclust_qft, 7)
...
mat4.2A_mva = mat4.2A_mva_wide %>% filter(OutcomeGroup %in% names1)
...
```{r}
contrib4.2A.1 = fviz_contrib(pca4.2Bres, axes = 1, choice = "ind")
#contrib2.2A.2 = fviz_contrib(pca2.2Ares, axes = 2, choice = "ind")
