...
pc2dat = contrib3.2A.2$data[which(contrib3.2A.2$data$contrib >= 2.5), ]
...
# Reflected outcomes need to be multiplied by -1

reflected = c(mva_pca_set[7:9])

mvapcares$estimate = ifelse(mvapcares$Outcome %in% reflected, mvapcares$estimate * -1, mvapcares$estimate * 1)

mvapcares$expestimate = exp(mvapcares$estimate)

mvapcares %>% filter(BH < 0.15)
...
AM_1.2x =glmmTMB(O17 ~ Treatment*Time + Gender*Time + FA + (1| ID), data = groupA, family = Gamma(link = "log"))
AS_1.2x = summary(AM_1.2x)

emm1.2x = emmeans(AM_1.2x, ~ Treatment * Time)
contrasts1.2x = data.frame(contrast(emm1.2x, method = contrast_list, adjust = "none"))
v1.2x = paste0(v1.2, "+ FA")
contrasts1.2x$Outcome = v1.2x

AM_1.3x = glmmTMB(O20 ~ Treatment*Time + Gender*Time + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_1.3x = summary(AM_1.3x)

emm1.3x = emmeans(AM_1.3x, ~ Treatment * Time)
contrasts1.3x = data.frame(contrast(emm1.3x, method = contrast_list, adjust = "none"))
v1.3x = paste0(v1.3, "+ FA")
contrasts1.3x$Outcome = v1.3x

AM_1.4x = glmmTMB(O31 ~ Treatment*Time + Gender*Time + QFT + FA + (1| ID), data = groupA, family = poisson(link = "log"))
AS_1.4x = summary(AM_1.4x)


emm1.4x = emmeans(AM_1.4x, ~ Treatment * Time)
contrasts1.4x = data.frame(contrast(emm1.4x, method = contrast_list, adjust = "none"))
v1.4x = paste0(v1.4, "+ QFT + FA")
contrasts1.4x$Outcome = v1.4x

AM_1.5x = glmmTMB(O27 ~ Treatment*Time + Gender*Time + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_1.5x = summary(AM_1.5x)

emm1.5x = emmeans(AM_1.5x, ~ Treatment * Time)
contrasts1.5x = data.frame(contrast(emm1.5x, method = contrast_list, adjust = "none"))
v1.5x = paste0(v1.5, "+ FA")
contrasts1.5x$Outcome = v1.5x

AM_1.6x = glmmTMB(O25 ~ Treatment*Time + Gender*Time + QFT + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_1.6x = summary(AM_1.6x)

emm1.6x = emmeans(AM_1.6x, ~ Treatment * Time)
contrasts1.6x = data.frame(contrast(emm1.6x, method = contrast_list, adjust = "none"))
v1.6x = paste0(v1.6, " QFT + FA")
contrasts1.6x$Outcome = v1.6x

AM_1.7x = glmmTMB(94-O15 ~ Treatment*Time + Gender*Time + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_1.7x = summary(AM_1.7x)

emm1.7x = emmeans(AM_1.7x, ~ Treatment * Time)
contrasts1.7x = data.frame(contrast(emm1.7x, method = contrast_list, adjust = "none"))
v1.7x = paste0(v1.7, " + FA")
contrasts1.7x$Outcome = v1.7x

AM_1.8x = glmmTMB(101 - O19 ~ Treatment*Time + Gender*Time + FA + (1| ID), data = groupA, family = Gamma(link = "log"))
AS_1.8x = summary(AM_1.8x)

emm1.8x = emmeans(AM_1.8x, ~ Treatment * Time)
contrasts1.8x = data.frame(contrast(emm1.8x, method = contrast_list, adjust = "none"))
v1.8x = paste0(v1.8, " + FA")
contrasts1.8x$Outcome = v1.8x

AM_1.9x = glmmTMB(101 - O36 ~ Treatment*Time + Gender*Time + QFT + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_1.9x = summary(AM_1.9x)

emm1.9x = emmeans(AM_1.9x, ~ Treatment * Time)
contrasts1.9x = data.frame(contrast(emm1.9x, method = contrast_list, adjust = "none"))
v1.9x = paste0(v1.9, " QFT + FA")
contrasts1.9x$Outcome = v1.9x

mvapcares = rbind(contrasts1.1, contrasts1.2x, contrasts1.3x, contrasts1.4x,
                  contrasts1.5x, contrasts1.6x, contrasts1.7x, contrasts1.8x, contrasts1.9x)
mvapcares = mvapcares %>% arrange(p.value)
...
reflected = c(mvapcares$Outcome[9], mvapcares$Outcome[80], mvapcares$Outcome[22])
...
AM_2.11x = glmmTMB(101 - O36 ~ QFT*Gender*Time + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_2.11x = summary(AM_2.11x)
...
contrasts2.7 = data.frame(contrast(emm2.7, method = contrast_list, adjust = "none"))
contrasts2.8 = data.frame(contrast(emm2.8, method = contrast_list, adjust = "none"))
contrasts2.9 = data.frame(contrast(emm2.9, method = contrast_list, adjust = "none"))
contrasts2.10 = data.frame(contrast(emm2.10, method = contrast_list, adjust = "none"))
contrasts2.11 = data.frame(contrast(emm2.11, method = contrast_list, adjust = "none"))
...
contrasts2.7$Outcome = v2.7
contrasts2.8$Outcome = v2.8
contrasts2.9$Outcome = v2.9
contrasts2.10$Outcome = v2.10
contrasts2.11$Outcome = v2.11

qftpcares = rbind(contrasts2.1, contrasts2.2, contrasts2.3, contrasts2.4,
                  contrasts2.5, contrasts2.6, contrasts2.7, contrasts2.8, contrasts2.9,
                  contrasts2.10, contrasts2.11)
...
qftpcares$estimate = ifelse(qftpcares$Outcome %in% v2.11, qftpcares$estimate * -1, qftpcares$estimate * 1)

qftpcares$expestimate = exp(qftpcares$estimate)

contrasts2.11x$expestimate = exp(contrasts2.11x$estimate)

qftpcares %>% filter(BH < 0.15)
...
AM_2.1x = glmmTMB(O13 ~ QFT*Time + Gender*Time + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_2.1x = summary(AM_2.1x)

emm2.1x = emmeans(AM_2.1x, ~ QFT * Time)
contrasts2.1x = data.frame(contrast(emm2.1x, method = contrast_list, adjust = "none"))
v2.1x = paste0(v2.1, " + FA")
contrasts2.1x$Outcome = v2.1x

# Adjust for FA

AM_2.2x = glmmTMB(O16 ~ QFT*Time + Gender*Time + FA + (1| ID), data = groupA, family = Gamma(link = "log"))
AS_2.2x = summary(AM_2.2x)

emm2.2x = emmeans(AM_2.2x, ~ QFT * Time)
contrasts2.2x = data.frame(contrast(emm2.2x, method = contrast_list, adjust = "none"))
v2.2x = paste0(v2.2, " + FA")
contrasts2.2x$Outcome = v2.2x

# Adjust for FA

AM_2.3x = glmmTMB(O21 ~ QFT*Time + Gender*Time + FA + (1| ID), data = groupA, family = Gamma(link = "log"))
AS_2.3x = summary(AM_2.3x)

emm2.3x = emmeans(AM_2.3x, ~ QFT * Time)
contrasts2.3x = data.frame(contrast(emm2.3x, method = contrast_list, adjust = "none"))
v2.3x = paste0(v2.3, " + FA")
contrasts2.3x$Outcome = v2.3x

# Adjust for FA

AM_2.4x = glmmTMB(O18 ~ QFT*Time + Gender*Time + FA + (1| ID), data = groupA, family = Gamma(link = "log"))
AS_2.4x = summary(AM_2.4x)

emm2.4x = emmeans(AM_2.4x, ~ QFT * Time)
contrasts2.4x = data.frame(contrast(emm2.4x, method = contrast_list, adjust = "none"))
v2.4x = paste0(v2.4, " + FA")
contrasts2.4x$Outcome = v2.4x

# Adjust for FA

AM_2.6x = glmmTMB(O23 ~ QFT*Time + Gender*Time + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_2.6x = summary(AM_2.6x)

emm2.6x = emmeans(AM_2.6x, ~ QFT * Time)
contrasts2.6x = data.frame(contrast(emm2.6x, method = contrast_list, adjust = "none"))
v2.6x = paste0(v2.6, " + FA")
contrasts2.6x$Outcome = v2.6x

# Adjust for MVA85A and FA

AM_2.8x = glmmTMB(O31 ~ QFT*Time + Gender*Time + Treatment + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_2.8x = summary(AM_2.8x)

emm2.8x = emmeans(AM_2.8x, ~ QFT * Time)
contrasts2.8x = data.frame(contrast(emm2.8x, method = contrast_list, adjust = "none"))
v2.8x = paste0(v2.8, " + MVA85A + FA")
contrasts2.8x$Outcome = v2.8x

# Adjust for MVA85A and FA

AM_2.9x = glmmTMB(O25 ~ QFT*Time + Gender*Time + Treatment + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_2.9x = summary(AM_2.9x)

emm2.9x = emmeans(AM_2.9x, ~ QFT * Time)
contrasts2.9x = data.frame(contrast(emm2.9x, method = contrast_list, adjust = "none"))
v2.9x = paste0(v2.9, " + MVA85A + FA")
contrasts2.9x$Outcome = v2.9x

# Adjust for MVA85A and FA

AM_2.11x = glmmTMB(101 - O36 ~ QFT*Time + Gender*Time + Treatment + FA + (1| ID), data = groupA, family = tweedie(link = "log"))
AS_2.11x = summary(AM_2.11x)

emm2.11x = emmeans(AM_2.11x, ~ QFT * Time)
contrasts2.11x = data.frame(contrast(emm2.11x, method = contrast_list, adjust = "none"))
v2.11x = paste0(v2.11, " + MVA85A + FA")
contrasts2.11x$Outcome = v2.11x

qftpcares = rbind(contrasts2.1x, contrasts2.2x, contrasts2.3x, contrasts2.4x,
                  contrasts2.5, contrasts2.6x, contrasts2.7, contrasts2.8x, contrasts2.9x, contrasts2.10, contrasts2.11x)
qftpcares = qftpcares %>% arrange(p.value)

qftpcares$BH = p.adjust(qftpcares$p.value, method = "BH", n = length(qftpcares$p.value))
qftpcares$BY = p.adjust(qftpcares$p.value, method = "BY", n = length(qftpcares$p.value))

qftpcares$estimate = ifelse(qftpcares$Outcome %in% qftpcares$Outcome[81], qftpcares$estimate * -1, qftpcares$estimate * 1)
...
contrasts3.7 = data.frame(contrast(emm3.7, method = contrast_list, adjust = "none"))
contrasts3.8 = data.frame(contrast(emm3.8, method = contrast_list, adjust = "none"))
contrasts3.9 = data.frame(contrast(emm3.9, method = contrast_list, adjust = "none"))
contrasts3.10 = data.frame(contrast(emm3.10, method = contrast_list, adjust = "none"))
contrasts3.11 = data.frame(contrast(emm3.11, method = contrast_list, adjust = "none"))
contrasts3.12 = data.frame(contrast(emm3.12, method = contrast_list, adjust = "none"))
contrasts3.13 = data.frame(contrast(emm3.13, method = contrast_list, adjust = "none"))
contrasts3.14 = data.frame(contrast(emm3.14, method = contrast_list, adjust = "none"))
contrasts3.15 = data.frame(contrast(emm3.15, method = contrast_list, adjust = "none"))
...
contrasts3.7$Outcome = v3.7
contrasts3.8$Outcome = v3.8
contrasts3.9$Outcome = v3.9
contrasts3.10$Outcome = v3.10
contrasts3.11$Outcome = v3.11
contrasts3.12$Outcome = v3.12
contrasts3.13$Outcome = v3.13
contrasts3.14$Outcome = v3.14
contrasts3.15$Outcome = v3.15

fapcares = rbind(contrasts3.1, contrasts3.2, contrasts3.3, contrasts3.4,
                  contrasts3.5, contrasts3.6, contrasts3.7, contrasts3.8, contrasts3.9,
                  contrasts3.10, contrasts3.11, contrasts3.12, contrasts3.13, contrasts3.14, contrasts3.15)
...
fapcares$estimate = ifelse(fapcares$Outcome %in% c(v3.6, v3.7, v3.8), fapcares$estimate * -1, fapcares$estimate * 1)

fapcares$expestimate = exp(fapcares$estimate)

fapcares %>% filter(BH < 0.15) 
...
AM_3.1 = glmmTMB(O17 ~ FA*Time + Gender*Time + Treatment + (1| ID), data = groupA, family = Gamma(link = "log"))
v3.1 = paste0(varA[17], " + MVA85A")

AM_3.2 = glmmTMB(O21 ~ FA*Time + Gender*Time + QFT + (1| ID), data = groupA, family = Gamma(link = "log"))
v3.2 = paste0(varA[21], " + QFT")

AM_3.3 = glmmTMB(O18 ~ FA*Time + Gender*Time + QFT + (1| ID), data = groupA, family = Gamma(link = "log"))
v3.3 = paste0(varA[18], " + QFT")

AM_3.4 = glmmTMB(O39 ~ FA*Time + Gender*Time + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.4 = varA[39]

AM_3.5 = glmmTMB(O25 ~ FA*Time + Gender*Time + Treatment + QFT + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.5 = paste0(varA[25], " + MVA85A + QFT")

AM_3.6 = glmmTMB(94-O15 ~ FA*Time + Gender*Time + Treatment + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.6 = paste0(varA[15], " + MVA85A")


AM_3.7 = glmmTMB(101 - O19 ~ FA*Time + Gender*Time + Treatment + (1| ID), data = groupA, family = Gamma(link = "log"))
v3.7 = paste0(varA[19], " + MVA85A")

AM_3.8 = glmmTMB(101 - O36 ~ FA*Time + Gender*Time + Treatment + QFT + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.8 = paste0(varA[36], " + MVA85A + QFT")

AM_3.9 = glmmTMB(O9 ~ FA*Time + Gender*Time + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.9 = varA[9]

AM_3.10 = glmmTMB(O13 ~ FA*Time + Gender*Time + QFT + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.10 = paste0(varA[13], " + QFT")

AM_3.11 = glmmTMB(O16 ~ FA*Time + Gender*Time + QFT + (1| ID), data = groupA, family = Gamma(link = "log"))
v3.11 = paste0(varA[16], " + QFT")

AM_3.12 = glmmTMB(O20 ~ FA*Time + Gender*Time + Treatment + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.12 = paste0(varA[20], " + MVA85A")

AM_3.13 = glmmTMB(O23 ~ FA*Time + Gender*Time + QFT + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.13 = paste0(varA[23], " + QFT")

AM_3.14 = glmmTMB(O31 ~ FA*Time + Gender*Time + Treatment + QFT + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.14 = paste0(varA[31], " + MVA85A + QFT")

AM_3.15 = glmmTMB(O27 ~ FA*Time + Gender*Time + Treatment + (1| ID), data = groupA, family = tweedie(link = "log"))
v3.15 = paste0(varA[27], " + MVA85A")
...
mvapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v1.1)
mvapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v1.2)
mvapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v1.3)
...
qftpcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v2.1)
qftpcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v2.2)
qftpcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v2.3)
qftpcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v2.4)
qftpcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v2.5)
qftpcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v2.6)
...
fapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v3.1)
fapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v3.2)
fapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v3.3)
fapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v3.4)
fapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v3.5)
fapcaresB %>% filter(BH < 0.15) %>% filter(Outcome == v3.6)
...
ggplot(Bmelt, aes(x = Variable, y = reorder(Outcome, Indicator), fill = Indicator)) +
  geom_tile(color = "black") + theme_bw() +
  theme(axis.text.y = element_text(size=9, family = "TT Arial"),
        axis.text.x = element_text(size=10, angle = 0, family = "TT Arial", face = "bold"),
        axis.title.y = element_blank(), axis.title.x = element_blank(), legend.position = "none") +
...
```{r}
pca4.2Ares = princomp(mat4.2A2_mva, cor = TRUE, scores = TRUE)
...
pc1dat = contrib4.2A$data[which(contrib4.2A$data$contrib >= 5), ]

pcnames1 = as.character(unique(c(pc1dat$name)))

sex_mva_setA = pcnames1
```
```{r}
pca4.2Ares = princomp(mat4.2A2_qft, cor = TRUE, scores = TRUE)
summary(pca4.2Ares) # Component 1 should suffice
...
pc1dat = contrib4.2A$data[which(contrib4.2A$data$contrib >= 3), ]

pcnames1 = as.character(unique(c(pc1dat$name)))

sex_qft_setA = pcnames1
```


```{r}
pca4.2Ares = princomp(mat4.2A2_fa, cor = TRUE, scores = TRUE)
summary(pca4.2Ares) # Component 1 should suffice
...
fviz_contrib(pca4.2Ares, axes = 1, choice = "ind", fill = "darkgrey", color = "black", top = 30) +
  labs(y = element_text("Contributions(%)\n")) +
  theme_minimal() +
  theme(title = element_blank(),
        axis.title.y = element_text(size = 12, face = "bold"),
...
pc1dat = contrib4.2A$data[which(contrib4.2A$data$contrib >= 1.5), ]

pcnames1 = as.character(unique(c(pc1dat$name)))

sex_fa_setA = pcnames1
```
...
mva_sex_namesA = (sex_df %>% filter(Group == "MVA85A"))
qft_sex_namesA = sex_df %>% filter(Group == "QFT")
fa_sex_namesA = unique((sex_df %>% filter(Group %in% c("FA - FA", "FA - BA"))))
...
mva_qft_namesA = find_exclusive_pairs(mva_sex_namesA$Outcome, qft_sex_namesA$Outcome, fa_sex_namesA$Outcome)

# For MVA85A and FA but not QFT

mva_fa_namesA = find_exclusive_pairs(mva_sex_namesA$Outcome, fa_sex_namesA$Outcome, qft_sex_namesA$Outcome)

# For QFT and FA but not MVA85A

qft_fa_namesA = find_exclusive_pairs(qft_sex_namesA$Outcome, fa_sex_namesA$Outcome, fa_sex_namesA$Outcome)
...
mva_namesA = find_exclusive(mva_sex_namesA$Outcome, qft_sex_namesA$Outcome, fa_sex_namesA$Outcome)

# For QFT only

qft_namesA = find_exclusive(qft_sex_namesA$Outcome, mva_sex_namesA$Outcome, fa_sex_namesA$Outcome)

# For FA only

fa_namesA = find_exclusive(fa_sex_namesA$Outcome, mva_sex_namesA$Outcome, qft_sex_namesA$Outcome)
...
Aset_list = list(MVA85A = mva_sex_namesA$Outcome, QFT = qft_sex_namesA$Outcome, FA = fa_sex_namesA$Outcome)

# Number per set

length(mva_sex_namesA$Outcome)
length(qft_sex_namesA$Outcome)
length(fa_sex_namesA$Outcome)

# Number of unique immune outcomes
unique(c(mva_sex_namesA$Outcome, qft_sex_namesA$Outcome, fa_sex_namesA$Outcome))
...
Bset_list = list(MVA85A = mva_sex_namesB$Outcome, QFT = qft_sex_namesB$Outcome, FA = fa_sex_namesB$Outcome)

# Number per set

length(mva_sex_namesB$Outcome)
length(qft_sex_namesB$Outcome)
length(fa_sex_namesB$Outcome)
...
mva_sex_namesB = sex_dfB %>% filter(Group == "MVA85A")
qft_sex_namesB = sex_dfB %>% filter(Group == "QFT") 
fa_sex_namesB = sex_dfB %>% filter(Group %in% c("FA - FA", "FA - BA"))
...
mva_qft_namesB = find_exclusive_pairs(mva_sex_namesB$Outcome, qft_sex_namesB$Outcome, fa_sex_namesB$Outcome)

# For MVA85A and FA but not QFT

mva_fa_namesB = find_exclusive_pairs(mva_sex_namesB$Outcome, fa_sex_namesB$Outcome, qft_sex_namesB$Outcome)

# For QFT and FA but not MVA85A

qft_fa_namesB = find_exclusive_pairs(qft_sex_namesB$Outcome, fa_sex_namesB$Outcome, fa_sex_namesB$Outcome)

# For MVA85A only

mva_namesB = find_exclusive(mva_sex_namesB$Outcome, qft_sex_namesB$Outcome, fa_sex_namesB$Outcome)

# For QFT only

qft_namesB = find_exclusive(qft_sex_namesB$Outcome, mva_sex_namesB$Outcome, fa_sex_namesB$Outcome)

# For FA only

fa_namesB = find_exclusive(fa_sex_namesB$Outcome, mva_sex_namesB$Outcome, qft_sex_namesB$Outcome)
