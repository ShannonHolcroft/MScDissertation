...
AM_0 = glmmTMB(O3 ~ Treatment*Time + Gender*Time + (1| ID), data = groupA, family = tweedie(link = "log"), na.action = na.omit)
AS_0 = summary(AM_0)
...
AM_0 = glmmTMB(94-O15 ~ QFT*Time + Gender*Time + (1| ID), data = groupA, family = gaussian(link = "identity"))
AS_0 = summary(AM_0)
...
AM_0 = glmmTMB(101 - O36 ~ Treatment*Time + Gender*Time + (1| ID), data = groupA, family = tweedie(link = "log"), na.action = na.exclude)
AS_0 = summary(AM_0)
